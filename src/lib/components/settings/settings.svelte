...
<div class="mx-auto w-full md:w-4/5">
	...
	<div class="mx-auto max-w-3xl pb-16">
		...
		<Alert.Root>
			...
			<Alert.Description class="text-muted-foreground">
				Ensure you only import a database that you exported from SimpleJournaler. Or things might
				break.
			</Alert.Description>
		</Alert.Root>
		<div class="mt-4">
	...
	<div class="mx-auto max-w-3xl pb-16">
		...
		<p class="text-sm text-muted-foreground">
			Save a database file to your current device if you're planning on using SimpleJournaler on
			another device.
		</p>
